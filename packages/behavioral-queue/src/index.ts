...
import { QueueAuthMiddleware } from "@meridiandb/shared/src/queue/middleware/QueueAuthMiddleware";
import { ValidatePayloadSizeMiddleware } from "@meridiandb/shared/src/queue/middleware/ValidatePayloadSizeMiddleware";
import ConsumerHandler from "ConsumeHandler";
const app = new Hono<Environment>();

// Helper to get Durable Object instance
async function getQueue(env: any): Promise<DurableObjectStub> {
  const id = env.SIMPLE_QUEUE.idFromName("dlq");
...
export { BehavioralDurableObjectQueue } from "./BehavioralDurableObjectQueue";
